...
public class OvernightIndexedSwapIndex : SwapIndex {
  ...
  public OvernightIndexedSwapIndex(string familyName, Period tenor, uint settlementDays, Currency currency, OvernightIndex overnightIndex, bool telescopicValueDates) : this(NQuantLibcPINVOKE.new_OvernightIndexedSwapIndex__SWIG_0(familyName, Period.getCPtr(tenor), settlementDays, Currency.getCPtr(currency), OvernightIndex.getCPtr(overnightIndex), telescopicValueDates), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }

  public OvernightIndexedSwapIndex(string familyName, Period tenor, uint settlementDays, Currency currency, OvernightIndex overnightIndex) : this(NQuantLibcPINVOKE.new_OvernightIndexedSwapIndex__SWIG_1(familyName, Period.getCPtr(tenor), settlementDays, Currency.getCPtr(currency), OvernightIndex.getCPtr(overnightIndex)), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }
