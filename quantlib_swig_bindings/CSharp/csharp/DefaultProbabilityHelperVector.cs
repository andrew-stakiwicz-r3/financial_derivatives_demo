...
public class DefaultProbabilityHelperVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<DefaultProbabilityHelper>
 {
  ...
  public DefaultProbabilityHelperVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public DefaultProbabilityHelperVector(global::System.Collections.Generic.IEnumerable<DefaultProbabilityHelper> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (DefaultProbabilityHelper element in c) {
      this.Add(element);
  ...
  public DefaultProbabilityHelper[] ToArray() {
    DefaultProbabilityHelper[] array = new DefaultProbabilityHelper[this.Count];
    this.CopyTo(array);
    return array;
  }
  ...
  private DefaultProbabilityHelper getitemcopy(int index) {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.DefaultProbabilityHelperVector_getitemcopy(swigCPtr, index);
    DefaultProbabilityHelper ret = (cPtr == global::System.IntPtr.Zero) ? null : new DefaultProbabilityHelper(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private DefaultProbabilityHelper getitem(int index) {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.DefaultProbabilityHelperVector_getitem(swigCPtr, index);
    DefaultProbabilityHelper ret = (cPtr == global::System.IntPtr.Zero) ? null : new DefaultProbabilityHelper(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
