...
public class FixedRateBondHelper : BondHelper {
  ...
  public FixedRateBond fixedRateBond() {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.FixedRateBondHelper_fixedRateBond(swigCPtr);
    FixedRateBond ret = (cPtr == global::System.IntPtr.Zero) ? null : new FixedRateBond(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
