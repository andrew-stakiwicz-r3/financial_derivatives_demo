...
public class QuoteVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<Quote>
 {
  ...
  public QuoteVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public QuoteVector(global::System.Collections.Generic.IEnumerable<Quote> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (Quote element in c) {
      this.Add(element);
  ...
  public Quote[] ToArray() {
    Quote[] array = new Quote[this.Count];
    this.CopyTo(array);
    return array;
  }
  ...
  private Quote getitemcopy(int index) {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.QuoteVector_getitemcopy(swigCPtr, index);
  ...
  private Quote getitem(int index) {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.QuoteVector_getitem(swigCPtr, index);
    Quote ret = (cPtr == global::System.IntPtr.Zero) ? null : new Quote(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
