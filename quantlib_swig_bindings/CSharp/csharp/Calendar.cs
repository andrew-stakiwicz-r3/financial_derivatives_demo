...
public class Calendar : global::System.IDisposable {
  ...
  public static DateVector holidayList(Calendar calendar, Date from, Date to, bool includeWeekEnds) {
    DateVector ret = new DateVector(NQuantLibcPINVOKE.Calendar_holidayList__SWIG_0(Calendar.getCPtr(calendar), Date.getCPtr(from), Date.getCPtr(to), includeWeekEnds), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static DateVector holidayList(Calendar calendar, Date from, Date to) {
    DateVector ret = new DateVector(NQuantLibcPINVOKE.Calendar_holidayList__SWIG_1(Calendar.getCPtr(calendar), Date.getCPtr(from), Date.getCPtr(to)), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
