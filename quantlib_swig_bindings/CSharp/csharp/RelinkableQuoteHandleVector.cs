...
public class RelinkableQuoteHandleVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<RelinkableQuoteHandle>
 {
  ...
  public RelinkableQuoteHandleVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public RelinkableQuoteHandleVector(global::System.Collections.Generic.IEnumerable<RelinkableQuoteHandle> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (RelinkableQuoteHandle element in c) {
      this.Add(element);
  ...
  public RelinkableQuoteHandle[] ToArray() {
    RelinkableQuoteHandle[] array = new RelinkableQuoteHandle[this.Count];
    this.CopyTo(array);
    return array;
  }
