...
public class DefaultProbabilityTermStructureHandle : global::System.IDisposable {
  ...
  public DefaultProbabilityTermStructure __deref__() {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.DefaultProbabilityTermStructureHandle___deref__(swigCPtr);
    DefaultProbabilityTermStructure ret = (cPtr == global::System.IntPtr.Zero) ? null : new DefaultProbabilityTermStructure(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public Observable asObservable() {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.DefaultProbabilityTermStructureHandle_asObservable(swigCPtr);
  ...
  public double timeFromReference(Date date) {
    double ret = NQuantLibcPINVOKE.DefaultProbabilityTermStructureHandle_timeFromReference(swigCPtr, Date.getCPtr(date));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
