...
public class GaussianSobolPathGenerator : global::System.IDisposable {
  ...
  public GaussianSobolPathGenerator(StochasticProcess arg0, double length, uint timeSteps, GaussianLowDiscrepancySequenceGenerator generator, bool brownianBridge) : this(NQuantLibcPINVOKE.new_GaussianSobolPathGenerator__SWIG_0(StochasticProcess.getCPtr(arg0), length, timeSteps, GaussianLowDiscrepancySequenceGenerator.getCPtr(generator), brownianBridge), true) {
  ...
  public SamplePath next() {
    SamplePath ret = new SamplePath(NQuantLibcPINVOKE.GaussianSobolPathGenerator_next(swigCPtr), false);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SamplePath antithetic() {
    SamplePath ret = new SamplePath(NQuantLibcPINVOKE.GaussianSobolPathGenerator_antithetic(swigCPtr), false);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint size() {
    uint ret = NQuantLibcPINVOKE.GaussianSobolPathGenerator_size(swigCPtr);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public TimeGrid timeGrid() {
    TimeGrid ret = new TimeGrid(NQuantLibcPINVOKE.GaussianSobolPathGenerator_timeGrid(swigCPtr), false);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
