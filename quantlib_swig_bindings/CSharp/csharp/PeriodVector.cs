...
public class PeriodVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<Period>
 {
  ...
  public PeriodVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public PeriodVector(global::System.Collections.Generic.IEnumerable<Period> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (Period element in c) {
      this.Add(element);
  ...
  public Period[] ToArray() {
    Period[] array = new Period[this.Count];
    this.CopyTo(array);
    return array;
  }
