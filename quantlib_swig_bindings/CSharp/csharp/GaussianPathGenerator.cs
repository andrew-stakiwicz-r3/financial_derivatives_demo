...
public class GaussianPathGenerator : global::System.IDisposable {
  ...
  public SamplePath antithetic() {
    SamplePath ret = new SamplePath(NQuantLibcPINVOKE.GaussianPathGenerator_antithetic(swigCPtr), false);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint size() {
    uint ret = NQuantLibcPINVOKE.GaussianPathGenerator_size(swigCPtr);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
