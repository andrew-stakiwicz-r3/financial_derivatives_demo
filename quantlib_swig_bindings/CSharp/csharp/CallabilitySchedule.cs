...
public class CallabilitySchedule : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<Callability>
 {
  ...
  public CallabilitySchedule(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public CallabilitySchedule(global::System.Collections.Generic.IEnumerable<Callability> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (Callability element in c) {
      this.Add(element);
  ...
  public Callability[] ToArray() {
    Callability[] array = new Callability[this.Count];
    this.CopyTo(array);
    return array;
  }
  ...
  private Callability getitemcopy(int index) {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.CallabilitySchedule_getitemcopy(swigCPtr, index);
    Callability ret = (cPtr == global::System.IntPtr.Zero) ? null : new Callability(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private Callability getitem(int index) {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.CallabilitySchedule_getitem(swigCPtr, index);
    Callability ret = (cPtr == global::System.IntPtr.Zero) ? null : new Callability(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
