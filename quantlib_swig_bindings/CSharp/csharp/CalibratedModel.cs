...
public class CalibratedModel : Observable {
  private global::System.Runtime.InteropServices.HandleRef swigCPtr;
  private bool swigCMemOwnDerived;

  internal CalibratedModel(global::System.IntPtr cPtr, bool cMemoryOwn) : base(NQuantLibcPINVOKE.CalibratedModel_SWIGSmartPtrUpcast(cPtr), true) {
  ...
  public void setParams(QlArray params_) {
    NQuantLibcPINVOKE.CalibratedModel_setParams(swigCPtr, QlArray.getCPtr(params_));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public Constraint constraint() {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.CalibratedModel_constraint(swigCPtr);
  ...
  public EndCriteria.Type endCriteria() {
    EndCriteria.Type ret = (EndCriteria.Type)NQuantLibcPINVOKE.CalibratedModel_endCriteria(swigCPtr);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public QlArray problemValues() {
    QlArray ret = new QlArray(NQuantLibcPINVOKE.CalibratedModel_problemValues(swigCPtr), false);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int functionEvaluation() {
    int ret = NQuantLibcPINVOKE.CalibratedModel_functionEvaluation(swigCPtr);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
