...
public class QuoteHandleVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<QuoteHandle>
 {
  ...
  public QuoteHandleVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public QuoteHandleVector(global::System.Collections.Generic.IEnumerable<QuoteHandle> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (QuoteHandle element in c) {
      this.Add(element);
  ...
  public QuoteHandle[] ToArray() {
    QuoteHandle[] array = new QuoteHandle[this.Count];
    this.CopyTo(array);
    return array;
  }
