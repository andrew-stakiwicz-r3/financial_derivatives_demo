...
public class Bond : Instrument {
  ...
  internal Bond(global::System.IntPtr cPtr, bool cMemoryOwn) : base(NQuantLibcPINVOKE.Bond_SWIGSmartPtrUpcast(cPtr), true) {
  ...
  public Bond(uint settlementDays, Calendar calendar, Date issueDate, Leg coupons) : this(NQuantLibcPINVOKE.new_Bond__SWIG_3(settlementDays, Calendar.getCPtr(calendar), Date.getCPtr(issueDate), Leg.getCPtr(coupons)), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }

  public Bond(uint settlementDays, Calendar calendar, Date issueDate) : this(NQuantLibcPINVOKE.new_Bond__SWIG_4(settlementDays, Calendar.getCPtr(calendar), Date.getCPtr(issueDate)), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }

  public Bond(uint settlementDays, Calendar calendar) : this(NQuantLibcPINVOKE.new_Bond__SWIG_5(settlementDays, Calendar.getCPtr(calendar)), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public CashFlow redemption() {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.Bond_redemption(swigCPtr);
