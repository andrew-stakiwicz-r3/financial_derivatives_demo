...
public class FdHestonDoubleBarrierEngine : PricingEngine {
  private global::System.Runtime.InteropServices.HandleRef swigCPtr;
  private bool swigCMemOwnDerived;

  internal FdHestonDoubleBarrierEngine(global::System.IntPtr cPtr, bool cMemoryOwn) : base(NQuantLibcPINVOKE.FdHestonDoubleBarrierEngine_SWIGSmartPtrUpcast(cPtr), true) {
    swigCMemOwnDerived = cMemoryOwn;
    swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
  }

  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(FdHestonDoubleBarrierEngine obj) {
    ...
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwnDerived) {
          ...
          NQuantLibcPINVOKE.delete_FdHestonDoubleBarrierEngine(swigCPtr);
        }
  ...
  public FdHestonDoubleBarrierEngine(HestonModel model, uint tGrid, uint xGrid, uint vGrid, uint dampingSteps) : this(NQuantLibcPINVOKE.new_FdHestonDoubleBarrierEngine__SWIG_2(HestonModel.getCPtr(model), tGrid, xGrid, vGrid, dampingSteps), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public FdHestonDoubleBarrierEngine(HestonModel model, uint tGrid, uint xGrid) : this(NQuantLibcPINVOKE.new_FdHestonDoubleBarrierEngine__SWIG_4(HestonModel.getCPtr(model), tGrid, xGrid), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }

  public FdHestonDoubleBarrierEngine(HestonModel model, uint tGrid) : this(NQuantLibcPINVOKE.new_FdHestonDoubleBarrierEngine__SWIG_5(HestonModel.getCPtr(model), tGrid), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }
