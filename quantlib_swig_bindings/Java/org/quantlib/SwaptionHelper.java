...
public class SwaptionHelper extends BlackCalibrationHelper {
  ...
  public SWIGTYPE_p_boost__shared_ptrT_VanillaSwap_t underlyingSwap() {
    return new SWIGTYPE_p_boost__shared_ptrT_VanillaSwap_t(QuantLibJNI.SwaptionHelper_underlyingSwap(swigCPtr, this), true);
  }

  public SWIGTYPE_p_boost__shared_ptrT_Swaption_t swaption() {
    return new SWIGTYPE_p_boost__shared_ptrT_Swaption_t(QuantLibJNI.SwaptionHelper_swaption(swigCPtr, this), true);
  }
