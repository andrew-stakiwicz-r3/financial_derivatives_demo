...
public class VanillaSwap extends Swap {
  ...
  public VanillaSwap(VanillaSwap.Type type, double nominal, Schedule fixedSchedule, double fixedRate, DayCounter fixedDayCount, Schedule floatSchedule, IborIndex index, double spread, DayCounter floatingDayCount) {
  ...
  public final static class Type {
    public final static VanillaSwap.Type Receiver = new VanillaSwap.Type("Receiver", QuantLibJNI.VanillaSwap_Receiver_get());
    public final static VanillaSwap.Type Payer = new VanillaSwap.Type("Payer", QuantLibJNI.VanillaSwap_Payer_get());
