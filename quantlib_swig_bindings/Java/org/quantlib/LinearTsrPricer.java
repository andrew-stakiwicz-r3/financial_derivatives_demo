...
public class LinearTsrPricer extends CmsCouponPricer {
  ...
  public LinearTsrPricer(SwaptionVolatilityStructureHandle swaptionVol, QuoteHandle meanReversion, YieldTermStructureHandle couponDiscountCurve, Settings settings) {
    this(QuantLibJNI.new_LinearTsrPricer__SWIG_0(SwaptionVolatilityStructureHandle.getCPtr(swaptionVol), swaptionVol, QuoteHandle.getCPtr(meanReversion), meanReversion, YieldTermStructureHandle.getCPtr(couponDiscountCurve), couponDiscountCurve, Settings.getCPtr(settings), settings), true);
  }
