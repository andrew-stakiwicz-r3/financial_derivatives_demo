...
public class AnalyticHestonEngine_Integration {
  ...
  public double calculate(double c_inf, SWIGTYPE_p_boost__functionT_double_fdoubleF_t f, double maxBound) {
    return QuantLibJNI.AnalyticHestonEngine_Integration_calculate__SWIG_0(swigCPtr, this, c_inf, SWIGTYPE_p_boost__functionT_double_fdoubleF_t.getCPtr(f), maxBound);
  }

  public double calculate(double c_inf, SWIGTYPE_p_boost__functionT_double_fdoubleF_t f) {
    return QuantLibJNI.AnalyticHestonEngine_Integration_calculate__SWIG_1(swigCPtr, this, c_inf, SWIGTYPE_p_boost__functionT_double_fdoubleF_t.getCPtr(f));
  }
