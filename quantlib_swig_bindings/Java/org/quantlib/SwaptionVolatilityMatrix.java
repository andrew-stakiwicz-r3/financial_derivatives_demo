...
public class SwaptionVolatilityMatrix extends SwaptionVolatilityDiscrete {
  ...
  public SWIGTYPE_p_std__pairT_std__size_t_std__size_t_t locate(Date optionDate, Period swapTenor) {
    return new SWIGTYPE_p_std__pairT_std__size_t_std__size_t_t(QuantLibJNI.SwaptionVolatilityMatrix_locate__SWIG_0(swigCPtr, this, Date.getCPtr(optionDate), optionDate, Period.getCPtr(swapTenor), swapTenor), true);
  }

  public SWIGTYPE_p_std__pairT_std__size_t_std__size_t_t locate(double optionTime, double swapLength) {
    return new SWIGTYPE_p_std__pairT_std__size_t_std__size_t_t(QuantLibJNI.SwaptionVolatilityMatrix_locate__SWIG_1(swigCPtr, this, optionTime, swapLength), true);
  }
