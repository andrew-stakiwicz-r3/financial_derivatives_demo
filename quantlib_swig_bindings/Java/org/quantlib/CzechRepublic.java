...
public class CzechRepublic extends Calendar {
  ...
  protected CzechRepublic(long cPtr, boolean cMemoryOwn) {
    super(QuantLibJNI.CzechRepublic_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        QuantLibJNI.delete_CzechRepublic(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public CzechRepublic(CzechRepublic.Market m) {
    this(QuantLibJNI.new_CzechRepublic__SWIG_0(m.swigValue()), true);
  }

  public CzechRepublic() {
    this(QuantLibJNI.new_CzechRepublic__SWIG_1(), true);
  }

  public final static class Market {
    public final static CzechRepublic.Market PSE = new CzechRepublic.Market("PSE");
    ...
    private static Market[] swigValues = { PSE };
