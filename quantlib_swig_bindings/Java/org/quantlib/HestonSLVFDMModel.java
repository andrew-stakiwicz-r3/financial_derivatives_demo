...
public class HestonSLVFDMModel {
  ...
  public HestonSLVFDMModel(LocalVolTermStructure localVol, HestonModel model, Date endDate, HestonSLVFokkerPlanckFdmParams params, boolean logging, DateVector mandatoryDates) {
    this(QuantLibJNI.new_HestonSLVFDMModel__SWIG_0(LocalVolTermStructure.getCPtr(localVol), localVol, HestonModel.getCPtr(model), model, Date.getCPtr(endDate), endDate, HestonSLVFokkerPlanckFdmParams.getCPtr(params), params, logging, DateVector.getCPtr(mandatoryDates), mandatoryDates), true);
  }
  ...
  public HestonSLVFDMModel(LocalVolTermStructure localVol, HestonModel model, Date endDate, HestonSLVFokkerPlanckFdmParams params, boolean logging) {
    this(QuantLibJNI.new_HestonSLVFDMModel__SWIG_1(LocalVolTermStructure.getCPtr(localVol), localVol, HestonModel.getCPtr(model), model, Date.getCPtr(endDate), endDate, HestonSLVFokkerPlanckFdmParams.getCPtr(params), params, logging), true);
  }
  ...
  public HestonSLVFDMModel(LocalVolTermStructure localVol, HestonModel model, Date endDate, HestonSLVFokkerPlanckFdmParams params) {
    this(QuantLibJNI.new_HestonSLVFDMModel__SWIG_2(LocalVolTermStructure.getCPtr(localVol), localVol, HestonModel.getCPtr(model), model, Date.getCPtr(endDate), endDate, HestonSLVFokkerPlanckFdmParams.getCPtr(params), params), true);
  }
