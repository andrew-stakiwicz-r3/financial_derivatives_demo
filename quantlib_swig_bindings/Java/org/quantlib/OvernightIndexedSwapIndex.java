...
public class OvernightIndexedSwapIndex extends SwapIndex {
  ...
  public OvernightIndexedSwapIndex(String familyName, Period tenor, long settlementDays, Currency currency, OvernightIndex overnightIndex, boolean telescopicValueDates) {
    this(QuantLibJNI.new_OvernightIndexedSwapIndex__SWIG_0(familyName, Period.getCPtr(tenor), tenor, settlementDays, Currency.getCPtr(currency), currency, OvernightIndex.getCPtr(overnightIndex), overnightIndex, telescopicValueDates), true);
  }
  ...
  public OvernightIndexedSwapIndex(String familyName, Period tenor, long settlementDays, Currency currency, OvernightIndex overnightIndex) {
    this(QuantLibJNI.new_OvernightIndexedSwapIndex__SWIG_1(familyName, Period.getCPtr(tenor), tenor, settlementDays, Currency.getCPtr(currency), currency, OvernightIndex.getCPtr(overnightIndex), overnightIndex), true);
  }
