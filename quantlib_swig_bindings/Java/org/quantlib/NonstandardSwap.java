...
public class NonstandardSwap extends Swap {
  ...
  public NonstandardSwap(VanillaSwap.Type type, DoubleVector fixedNominal, DoubleVector floatingNominal, Schedule fixedSchedule, DoubleVector fixedRate, DayCounter fixedDayCount, Schedule floatSchedule, IborIndex index, DoubleVector gearing, DoubleVector spread, DayCounter floatDayCount) {
  ...
  public VanillaSwap.Type type() {
    return VanillaSwap.Type.swigToEnum(QuantLibJNI.NonstandardSwap_type(swigCPtr, this));
  }
