...
public class ExtendedOrnsteinUhlenbeckProcess extends StochasticProcess1D {
  ...
  public ExtendedOrnsteinUhlenbeckProcess(double speed, double sigma, double x0, SWIGTYPE_p_boost__functionT_double_fdoubleF_t b, ExtendedOrnsteinUhlenbeckProcess.Discretization discretization, double intEps) {
    this(QuantLibJNI.new_ExtendedOrnsteinUhlenbeckProcess__SWIG_0(speed, sigma, x0, SWIGTYPE_p_boost__functionT_double_fdoubleF_t.getCPtr(b), discretization.swigValue(), intEps), true);
  }

  public ExtendedOrnsteinUhlenbeckProcess(double speed, double sigma, double x0, SWIGTYPE_p_boost__functionT_double_fdoubleF_t b, ExtendedOrnsteinUhlenbeckProcess.Discretization discretization) {
    this(QuantLibJNI.new_ExtendedOrnsteinUhlenbeckProcess__SWIG_1(speed, sigma, x0, SWIGTYPE_p_boost__functionT_double_fdoubleF_t.getCPtr(b), discretization.swigValue()), true);
  }

  public ExtendedOrnsteinUhlenbeckProcess(double speed, double sigma, double x0, SWIGTYPE_p_boost__functionT_double_fdoubleF_t b) {
    this(QuantLibJNI.new_ExtendedOrnsteinUhlenbeckProcess__SWIG_2(speed, sigma, x0, SWIGTYPE_p_boost__functionT_double_fdoubleF_t.getCPtr(b)), true);
  }
