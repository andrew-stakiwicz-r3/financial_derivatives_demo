...
public class FDDividendEuropeanEngine extends PricingEngine {
  ...
  protected FDDividendEuropeanEngine(long cPtr, boolean cMemoryOwn) {
    super(QuantLibJNI.FDDividendEuropeanEngine_SWIGSmartPtrUpcast(cPtr), true);
  ...
  public FDDividendEuropeanEngine(GeneralizedBlackScholesProcess process, long timeSteps, long gridPoints, boolean timeDependent) {
    this(QuantLibJNI.new_FDDividendEuropeanEngineT__SWIG_0(GeneralizedBlackScholesProcess.getCPtr(process), process, timeSteps, gridPoints, timeDependent), true);
  }

  public FDDividendEuropeanEngine(GeneralizedBlackScholesProcess process, long timeSteps, long gridPoints) {
    this(QuantLibJNI.new_FDDividendEuropeanEngineT__SWIG_1(GeneralizedBlackScholesProcess.getCPtr(process), process, timeSteps, gridPoints), true);
  }

  public FDDividendEuropeanEngine(GeneralizedBlackScholesProcess process, long timeSteps) {
    this(QuantLibJNI.new_FDDividendEuropeanEngineT__SWIG_2(GeneralizedBlackScholesProcess.getCPtr(process), process, timeSteps), true);
  }

  public FDDividendEuropeanEngine(GeneralizedBlackScholesProcess process) {
    this(QuantLibJNI.new_FDDividendEuropeanEngineT__SWIG_3(GeneralizedBlackScholesProcess.getCPtr(process), process), true);
  }
