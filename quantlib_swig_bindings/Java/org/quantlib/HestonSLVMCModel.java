...
public class HestonSLVMCModel {
  ...
  public HestonSLVMCModel(LocalVolTermStructure localVol, HestonModel model, BrownianGeneratorFactory brownianGeneratorFactory, Date endDate, long timeStepsPerYear, long nBins, long calibrationPaths, DateVector mandatoryDates) {
    this(QuantLibJNI.new_HestonSLVMCModel__SWIG_0(LocalVolTermStructure.getCPtr(localVol), localVol, HestonModel.getCPtr(model), model, BrownianGeneratorFactory.getCPtr(brownianGeneratorFactory), brownianGeneratorFactory, Date.getCPtr(endDate), endDate, timeStepsPerYear, nBins, calibrationPaths, DateVector.getCPtr(mandatoryDates), mandatoryDates), true);
  }
  ...
  public HestonSLVMCModel(LocalVolTermStructure localVol, HestonModel model, BrownianGeneratorFactory brownianGeneratorFactory, Date endDate, long timeStepsPerYear, long nBins, long calibrationPaths) {
    this(QuantLibJNI.new_HestonSLVMCModel__SWIG_1(LocalVolTermStructure.getCPtr(localVol), localVol, HestonModel.getCPtr(model), model, BrownianGeneratorFactory.getCPtr(brownianGeneratorFactory), brownianGeneratorFactory, Date.getCPtr(endDate), endDate, timeStepsPerYear, nBins, calibrationPaths), true);
  }
  ...
  public HestonSLVMCModel(LocalVolTermStructure localVol, HestonModel model, BrownianGeneratorFactory brownianGeneratorFactory, Date endDate, long timeStepsPerYear, long nBins) {
    this(QuantLibJNI.new_HestonSLVMCModel__SWIG_2(LocalVolTermStructure.getCPtr(localVol), localVol, HestonModel.getCPtr(model), model, BrownianGeneratorFactory.getCPtr(brownianGeneratorFactory), brownianGeneratorFactory, Date.getCPtr(endDate), endDate, timeStepsPerYear, nBins), true);
  }
  ...
  public HestonSLVMCModel(LocalVolTermStructure localVol, HestonModel model, BrownianGeneratorFactory brownianGeneratorFactory, Date endDate, long timeStepsPerYear) {
    this(QuantLibJNI.new_HestonSLVMCModel__SWIG_3(LocalVolTermStructure.getCPtr(localVol), localVol, HestonModel.getCPtr(model), model, BrownianGeneratorFactory.getCPtr(brownianGeneratorFactory), brownianGeneratorFactory, Date.getCPtr(endDate), endDate, timeStepsPerYear), true);
  }
  ...
  public HestonSLVMCModel(LocalVolTermStructure localVol, HestonModel model, BrownianGeneratorFactory brownianGeneratorFactory, Date endDate) {
    this(QuantLibJNI.new_HestonSLVMCModel__SWIG_4(LocalVolTermStructure.getCPtr(localVol), localVol, HestonModel.getCPtr(model), model, BrownianGeneratorFactory.getCPtr(brownianGeneratorFactory), brownianGeneratorFactory, Date.getCPtr(endDate), endDate), true);
  }
