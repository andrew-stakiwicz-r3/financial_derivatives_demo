...
public class EuropeanExercise extends Exercise {
  ...
  protected EuropeanExercise(long cPtr, boolean cMemoryOwn) {
    super(QuantLibJNI.EuropeanExercise_SWIGSmartPtrUpcast(cPtr), true);
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwnDerived) {
        ...
        QuantLibJNI.delete_EuropeanExercise(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public EuropeanExercise(Date date) {
    this(QuantLibJNI.new_EuropeanExercise(Date.getCPtr(date), date), true);
  }
