...
@CordaService
class ValuationOracle(val services: ServiceHub) : SingletonSerializeAsToken() {
    ...
    fun queryDiscountCurve(isoDate: String): Double {
        //finance.logic.DiscountCurve dc = new finance.logic.DiscountCurve()
